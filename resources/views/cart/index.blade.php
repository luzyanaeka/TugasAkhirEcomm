                        ...
                        @foreach ($products as $product)
                            <div class="col-12 d-flex p-2 justify-content-between cart-item">
                                ...
                                <div class="item-detail mr-auto d-flex flex-column justify-content-center">
                                    ...
                                    <div class="info-3"><h6>Ukuran: {{ $product['size'] }}</h6></div>
                                    <div class="info-4"><h6>Banyaknya: {{ $product['quantity'] }}</h6></div>
                                    <div class="info-5">
                        ...
                        <div class="card-body">
                            <div class="cart-checkout">
                                ...
                                <div class="info-3 pt-3">
                                    <a href="{{ route('checkout.index') }}"><button class="button-primary w-100">BAYAR</button></a>
                                </div>
    ...
    <div class="container p-0 ">
        <div class="row">
            <div class="col-12 d-flex flex-column justify-content-center align-items-center empty-cart">
                ...
                <div><a href="{{ route('product.index') }}">Silahkan lihat katalog kami kak :)</a></div>
            </div>
        </div>
    </div>
