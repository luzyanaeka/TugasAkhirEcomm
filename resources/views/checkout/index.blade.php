        ...
        <div class="col-7 mx-auto">
            ...
            <form action="{{ route('checkout') }}" method="POST" id="checkout-form">
                ...
                <div class="row ">
                    ...
                    <div class="col-12">
                        <label for="creditcardnumber" class="">{{ __('Nomor Kartu Kredit/Debit') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-6">
                        <label for="expiremonth" class="">{{ __('Tanggal Kadaluasa') }}</label>
                        <div class="form-group">
                            <div>
                    ...
                    <div class="col-6">
                        <label for="expireyear" class="">{{ __('Tahun Kadaluasa') }}</label>
                        <div class="form-group">
                            <div>
                ...
                <button type="submit" class="button-primary w-100">BAYAR</button>
